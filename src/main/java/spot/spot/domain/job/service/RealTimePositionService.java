...
import spot.spot.domain.job.mapper.RealTimePositionMapper;
...
public class RealTimePositionService {

    private final SimpMessageSendingOperations template;
    private final MemberRepository memberRepository;
    private final JwtUtil jwtUtil;
    private final RealTimePositionMapper realTimePositionMapper;
    ...
    public void sendPosition (PositionRequest request, String atk) {
        ...
        PositionResponse response = realTimePositionMapper.toPositionResponse(sender, request);
